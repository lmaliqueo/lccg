...
@section('content')
	...
	{!! Form::open(['route' => 'ordencompra.store', 'method'=>'POST', 'class'=>'ui form']) !!}
...
{{--   <div class="active step 1" id="step1">
   ...
   --}}
	...
	<div class="disabled step 2" id="step2">
		<i class="cubes outline icon " id="icon_step_2"></i>
		<div class="content">
	...
	<div class="disabled step 3" id="step3">
		<i class="file text icon " id="icon_step_3"></i>
		<div class="content">
			<div class="title">Orden de Compra</div>
...
<div class="ui attached segment animated fadeIn secondary" id="step_1">
	<div class="segment raised ui">
		...
		<div class="field">
			...
			{!! Form::text('proveedor[prov_contacto]', null, ['placeholder'=>'', 'class'=>'proveedor']) !!}
		</div>
	</div>
				...
				<tr>
					...
					<td style="width: 25%">
						<div class="ui labeled input">
							...
							{!! Form::number('orden_compra[oc_numero]', $num_oc, ['placheholder'=>'', 'min'=>1]) !!}
						</div>
					</td>
		...
		<table class="ui table celled">
			...
			<tbody id="ficha_items">
				...
				<tr>
					...
					<td class="collapsing"><a href="#" class="ui button small negative" id="rem_trow">quitar</a></td>
				</tr> --}}
			</tbody>
		</table>
	</div>
...
$(function() {
    ...
    {{-- 
        $(document).on('click', '#add_trow', function() {
            ...
            $('<tr class="animated fadeInDown"><td><input class="form-control" name="item['+count+i+'][item]" type="number"></td><td></td><td></td><td></td><td><input class="form-control" name="item['+count+i+'][cantidad]" type="text"></td><td class="collapsing"><a href="#" class="ui button small negative" id="rem_trow">quitar</a></td></tr>').appendTo(scntDiv);
            i++;
            return false;
        });
        --}}
